...
class BetController {
  ...
  def legWon = {
    ...
    winningLeg.bookie.transaction(new BookieTransaction(betLeg: winningLeg, moneyIn: winningLeg.profit))
    winningLeg.bookie.save(flush: true)
  ...
  def betVoid = {
    ...
    if (betInstance) {
      try {
        betInstance.voided = true
        flash.message = "Bet Voided"
